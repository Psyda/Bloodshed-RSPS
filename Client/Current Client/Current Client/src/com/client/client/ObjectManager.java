...
final class ObjectManager {
    ...
    public void method175(int y, WorldController worldController, CollisionDetection class11, int j, int z, int x, int i1, int j1) {
		...
		int actualH = z;
		//ARLO
		//objects inside edgeville men house
		if(actualX < 3091|| actualY < 3507 || actualX > 3100 || actualY > 3513) {
			//yanilla general exchange
			if(actualX < 2590|| actualY < 3086 || actualX > 2595 || actualY > 3087) {
				//yanilla general exchange
				if(actualX < 2594|| actualY < 3084 || actualX > 2595 || actualY > 3090) {
					//yanilla removeladder
					if(actualX < 2595|| actualY < 3093 || actualX > 2599 || actualY > 3097) {
						//yanilla middlebank
						if(actualX < 2607|| actualY < 3091 || actualX > 2610 || actualY > 3093) {
							//yanilla redportalshit
							if(actualX < 2603|| actualY < 3105 || actualX > 2606 || actualY > 3108) {
//bank wall removal - remove bank 
		if(actualX < 3092|| actualY < 3488 || actualX > 3097 || actualY > 3503) {	
//bankwalland chest east side 
		if(actualX < 3098|| actualY < 3489 || actualX > 3098 || actualY > 3493) {
//wall inside bank 1 
		if(actualX < 3096|| actualY < 3493 || actualX > 3098 || actualY > 3494) {
			//clipping fix tiles1 
			if(actualX < 3074|| actualY < 3502 || actualX > 3101 || actualY > 3505) {
				//clipping fix tiles2 
				if(actualX < 3084|| actualY < 3484 || actualX > 3088 || actualY > 3498) {
					//clipping fix tiles3 
					if(actualX < 3102|| actualY < 3504 || actualX > 3112 || actualY > 3509) {
                                 ...
                                 int k1)
    {
        ...
        int absY = (j + tileY);
            ...
            do
            {
                ...
                if(absX >= 3092 && absX <= 3097 && absY >= 3488 && absY <= 3499)
                	overLay[tilePlane][tileX][tileY] = 31;
                if(absX >= 3091 && absX <= 3091 && absY >= 3490 && absY <= 3491)
                	overLay[tilePlane][tileX][tileY] = 31;
                if(absX >= 3098 && absX <= 3098 && absY >= 3497 && absY <= 3498)
                	overLay[tilePlane][tileX][tileY] = 31;
                if(tileType <= 49)
                {
