...
public final class ItemDefinition {
    ...
    public static ItemDefinition forID(int i) {
        ...
        case 15670:
        	...
        	itemDef.femaleEquip1 = 63501;
        	itemDef.maleEquip1 = 63502;
        	itemDef.modelID = 63503;
        ...
        case 15671:
        	...
        	itemDef.femaleEquip1 = 63504;
        	itemDef.femaleEquip2 = 63505;
        	itemDef.maleEquip1 = 63506;
        	itemDef.maleEquip2 = 63507;
        	itemDef.modelID = 63508;
        	itemDef.groundActions = new String[] { null, null, "Take", null, null };
			itemDef.actions = new String[] { null, "Wear", null, null, "Drop" };
        	...
        	break;
        case 15672:
        	itemDef.femaleEquip1 = 63509;
        	itemDef.maleEquip1 = 63510;
        	itemDef.modelID = 63511;
        	itemDef.groundActions = new String[] { null, null, "Take", null, null };
			itemDef.actions = new String[] { null, "Wear", null, null, "Drop" };
        	...
        	itemDef.modelZoom = 2281;
        	break;
        case 15673:
			itemDef.name = "Elder maul";
			itemDef.modelID = 63512;
			itemDef.maleEquip1 = 63513;
			itemDef.femaleEquip1 = 63513;
        ...
        case 15674:
			...
			itemDef.maleEquip1 = 63515;
			itemDef.femaleEquip1 = 63515;
			itemDef.editedModelColor = new int[1];
			itemDef.newModelColor = new int[1];
			itemDef.editedModelColor[0] = 0;
			...
			break;
        case 15675:
        	itemDef.femaleEquip1 = 63516;
        	itemDef.femaleYOffset = 6;
        	itemDef.groundActions = new String[] { null, null, "Take", null, null };
			itemDef.actions = new String[] { null, "Wield", null, null, "Drop" };
			itemDef.modelID = 63517;
        	itemDef.maleEquip1 = 63516;
        ...
        break;
        case 15676:
        	itemDef.femaleEquip1 = 63518;
        	itemDef.femaleYOffset = 6;
        	itemDef.groundActions = new String[] { null, null, "Take", null, null };
			itemDef.actions = new String[] { null, "Wield", null, null, "Drop" };
			itemDef.modelID = 63519;
			itemDef.maleEquip1 = 63518;
        ...
        case 15677:
        	...
        	itemDef.femaleEquip1 = 63521;
        	itemDef.maleEquip1 = 63522;
        	itemDef.modelID = 63523;
        ...
        break;
        case 15678:
        	itemDef.femaleEquip1 = 63524;
        	itemDef.femaleEquip2 = 63525;
        	itemDef.groundActions = new String[] { null, null, "Take", null, null };
			itemDef.actions = new String[] { null, "Wear", null, null, "Drop" };
			itemDef.modelID = 63526;
			itemDef.maleEquip1 = 63527;
        ...
        case 15679:
        	...
        	itemDef.shadow = 20;
        	itemDef.femaleEquip1 = 63529;
        	itemDef.groundActions = new String[] { null, null, "Take", null, null };
			itemDef.actions = new String[] { null, "Wear", null, null, "Drop" };
			itemDef.modelID = 63530;
			itemDef.maleEquip1 = 63531;
     ...
     case 5573:
		...
		case 5572:
            ...
            case 4680:
            	...
            	itemDef.modelID = 37425;//lets try 1 before bath ready i do it for u cause i love uhahahahah so show me one of these that dont work in 
            	itemDef.modelZoom = 1000;
            	itemDef.rotationY = 1100;
            	itemDef.rotationX = 969;
            	itemDef.modelOffsetX = 6;
        ...
        /*    case 14044:
         ...
         //  itemDef.editedModelColor = new int[] { 61, 33, 24 };
           // 	itemDef.newModelColor = new int[] { 24, 61, 41 };
            	itemDef.groundActions = new String[] { null, null, "Take", null, null };
            	itemDef.actions = new String[] { null, "Wear", null, null, "Drop" };
            	itemDef.modelID = 2509;
            	itemDef.maleEquip1 = 27148;
            	itemDef.femaleEquip1 = 27148;
            	break;
            case 14044:
                itemDef.name = "Black Party Hat";
                itemDef.modelID = 2635;
            ...
            case 19476:
                ...
                itemDef.modelOffset1 = 0;
                itemDef.modelOffsetY = 0;
                itemDef.maleEquip1 = 6556;
                itemDef.femaleEquip1 = 6557;
                itemDef.groundActions = new String[5];
                itemDef.groundActions[2] = "Take";
                itemDef.actions = new String[5];
                itemDef.actions[1] = "Wear";
            ...
            case 19478:
        		...
        		itemDef.modelOffset1 = 5;
        		itemDef.modelOffsetY = 11;
        		itemDef.maleEquip1 = 6562;
                itemDef.femaleEquip1 = 6563;
        		itemDef.groundActions = new String[5];
        		itemDef.groundActions[2] = "Take";
        		itemDef.actions = new String[5];
        		itemDef.actions[1] = "Wear";
