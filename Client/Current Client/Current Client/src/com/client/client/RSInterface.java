...
public class RSInterface {
	...
	public static void gambleBlackJack(TextDrawingArea[] tda) {
		...
		addHoverButtonWSpriteLoader(index, 1046, 123, 48, "Stay", -1, index + 100, 5);
		setBounds(index, 115, 275, frame, main);
		frame++;

		addHoveredImageWSpriteLoader(index + 100, 1047, 123, 48, index + 100 + 1);
		setBounds(index + 100, 115, 275, frame, main);
		index++;
		frame++;

		addHoverButtonWSpriteLoader(index, 1048, 123, 48, "Hit", -1, index + 200, 5);
		setBounds(index, 275, 275, frame, main);
		frame++;

		addHoveredImageWSpriteLoader(index + 200, 1049, 123, 48, index + 200 + 1);
	...
	public static void gambleNewInterfaces(TextDrawingArea[] tda) {
		...
		addConfigButtonWSpriteLoader(id, 30891, 1042, 1044, 77, 27, "55x2", 1, 5, 1107, id + hover);
		setBounds(id, 180, 92, frame, tab);
		frame++;
		addHoveredImageWSpriteLoader(id + hover,  1043, 77, 27, id + hover + 1);
		setBounds(id + hover, 180, 92, frame, tab);
		frame++;
		id++;
		hover += 100;

		addConfigButtonWSpriteLoader(id, 30891, 1042, 1044, 77, 27, "Flower Poker", 2, 5, 1107, id + hover);
		...
		addConfigButtonWSpriteLoader(id, 30891, 1042, 1044, 77, 27, "Dice Duel", 3, 5, 1107, id + hover);
		...
		addConfigButtonWSpriteLoader(id, 30891, 1042, 1044, 77, 27, "Black Jack", 4, 5, 1107, id + hover);
		...
		addConfigButtonWSpriteLoader(id, 30891, 1042, 1044, 77, 27, "Frosty Flower", 5, 5, 1107, id + hover);
		...
		addConfigButtonWSpriteLoader(id, 30891, 1042, 1044, 77, 27, "ABC Flowers", 6, 5, 1107, id + hover);
		...
		addConfigButtonWSpriteLoader(id, 30891, 1042, 1044, 77, 27, "Hot or Cold", 7, 5, 1107, id + hover);
		...
		addConfigButtonWSpriteLoader(id, 30891, 1042, 1044, 77, 27, "Random Game", 8, 5, 1107, id + hover);
		...
		/*
		 * addHoverButtonWSpriteLoader(id, 1058, 18, 18, "Close", -1, id + 90,
		 * 3); setBounds(id, 195 + 284, 19, frame, tab); frame++;
		 * addHoveredImageWSpriteLoader(id + 90, 1059, 18, 18, id + 91);
		 * setBounds(id + 90, 195 + 284, 19, frame, tab); frame++; id++;
		 */

		addHoverButtonWSpriteLoader(id, 1050, 62, 22, "Accept", -1, id + 190, 5);
		setBounds(id, 261, 279, frame, tab);
		frame++;
		addHoveredImageWSpriteLoader(id + 190, 1051, 62, 22, id + 191);
		setBounds(id + 190, 261, 279, frame, tab);
		frame++;
		id++;

		addHoverButtonWSpriteLoader(id, 1052, 62, 22, "Decline", -1, id + 290, 5);
		setBounds(id, 189, 279, frame, tab);
		frame++;
		addHoveredImageWSpriteLoader(id + 290, 1053, 62, 22, id + 291);
	...
	public static void gambleInterfaces(TextDrawingArea[] tda) {
		...
		addHoverButtonWSpriteLoader(id, 1046, 128, 43, "Select Option One", -1, id + 100, 5);
		setBounds(id, 140, 291, frame, game);
		frame++;
		addHoveredImageWSpriteLoaderTrans(id + 100, 1047, 128, 43, id + 101, 128);
		setBounds(id + 100, 140, 291, frame, game);
		frame++;
		id++;

		addHoverButtonWSpriteLoader(id, 1048, 128, 43, "Select Option Two", -1, id + 200, 5);
		setBounds(id, 265, 291, frame, game);
		frame++;
		addHoveredImageWSpriteLoaderTrans(id + 200, 1049, 128, 43, id + 201, 64);
	...
	private static void dropTableCheckerInterface(TextDrawingArea[] rsFont) {
		...
		setChildren(25, main_widget);

		addHoverButtonWSpriteLoader(38200, 1024, 164, 22, "Search", -1, 38201, 1);
		addHoveredImageWSpriteLoader(38201, 1025, 164, 22, 38202);
		setBounds(38200, 27, 16, 23, main_widget);
		setBounds(38201, 27, 16, 24, main_widget);

		addSprite(28552, 1, "data/curs/drop/IMAGE");
		setBounds(28552, 27, 45, 4, main_widget);

		addSprite(37601, 0, "data/curs/drop/IMAGE");
		setBounds(37601, 21, 10, 0, main_widget);

		addText(37602, "NPC Drop Table Checker", 0xFF981F, true, true, -1, 2);
		setBounds(37602, 270, 16, 1, main_widget);

		addHoverButton(37603, "data/curs/drop/CLOSE", 3, 21, 21, "Close", -1, 37604, 3);
		addHoveredButton(37604, "data/curs/drop/CLOSE", 4, 21, 21, 2);

		setBounds(37603, 474, 17, 2, main_widget);
		setBounds(37604, 474, 17, 3, main_widget);
		...
		addSprite(38553, 0, "data/curs/drop/TAB");
	...
	public static void playerOwnedShopInterface(TextDrawingArea[] tda) {
		...
		addSpriteLoader(32601, 1035);

		addHoverButtonWSpriteLoader(32602, 1040, 115, 22, "Search Players", 0, 32603, 1);
		addHoveredImageWSpriteLoader(32603, 1041, 115, 22, 32604);

		addHoverButtonWSpriteLoader(32616, 1040, 115, 22, "Search Items", 0, 32617, 1);
		addHoveredImageWSpriteLoader(32617, 1041, 115, 22, 32618);
		...
		addHoverButtonWSpriteLoader(32613, 1038, 99, 19, "Claim earnings", 0, 32614, 1);
		addHoveredImageWSpriteLoader(32614, 1039, 99, 19, 32615);

		addHoverButtonWSpriteLoader(34619, 1036, 99, 32, "Edit your shop", 0, 34620, 1);
		addHoveredImageWSpriteLoader(34620, 1037, 99, 32, 34621);
	...
	public static void newStarter(TextDrawingArea[] tda) {
		...
		addText(52752, "Bloodshed - Account Setup", 0xff9933, true, true, 52, tda, 3);
		...
		addText(52764, "Play Bloodshed as an Iron man.", 0xff9933, true, true, 52, tda, 0);
	...
	addHoveredButton(37437, "Interfaces/Tele/TBUTTONS/BH", 11, 81, 34, 37638);
					...
					addText(50430, "Bloodshed Teleports", fonts, 2, 0xff9040, true, true); //rename it whatever
	...
	addHoveredButton(38433, "Interfaces/Tele/DBUTTONS/BH", 9, 81, 34, 38634);
					...
					addText(50430, "Bloodshed Teleports", fonts, 2, 0xff9040, true, true);
...
public static void TeleTAB5() {
		...
		while (stream.currentOffset < stream.buffer.length) {
			...
			if (rsInterface.type == 4) {
				rsInterface.message = stream.readString().replaceAll(
						"RuneScape", "Bloodshed");
				if(rsInterface.message.toLowerCase().equals("the bank of Bloodshed")) {
					rsInterface.message = "        The Bank of Bloodshed";
				}
	...
	public static void telePanel(TextDrawingArea wid[]) {
...
//
	...
	private static void questTabInterfaceNew() {
		...
		scroll.width = 174; scroll.height = 220; scroll.scrollMax = 1000;
		int k = 0;
		int y = 4;
		for(int i = 26701; i < 26771; i++) {
			...
			y += 14;
			k++;
			if(i == 26713 || i == 26716 || i == 26717 || i == 26718 || i == 26745 || i == 26746 || i == 26747 || i == 26751 || i == 26752) {
    ...
    public static void statistics1(final TextDrawingArea[] tda) {
        ...
        addText(id + 3, "Bloodshed", 0xAF6A1B, false, true, 0, tda, 2);
...
public static void addHoverSpriteLoaderButton(int i, int spriteId,
	...
	public static void trainingTeleports(TextDrawingArea[] tda) {
		...
		addText(60656, "Monsters", tda, 2, 0x4acc7e, true, true);
		addText(60657, "Minigames", tda, 2, 0x4acc7e, true, true);
		addText(60658, "Bosses I", tda, 2, 0x4acc7e, true, true);
		addText(60659, "Bosses II", tda, 2, 0x4acc7e, true, true);
		addText(60660, "Player-Killing", tda, 2, 0x4acc7e, true, true);
		addText(60661, "Dungeons", tda, 2, 0x4acc7e, true, true);

		addText(60662, "", tda, 2, 0xa8b5ab, true, true);
		addText(60663, "", tda, 2, 0xa8b5ab, true, true);
		addText(60664, "", tda, 2, 0xa8b5ab, true, true);
		addText(60665, "", tda, 2, 0xa8b5ab, true, true);
		addText(60666, "", tda, 2, 0xa8b5ab, true, true);
		addText(60667, "", tda, 2, 0xa8b5ab, true, true);
		addText(60668, "", tda, 2, 0xa8b5ab, true, true);
		addText(60669, "", tda, 2, 0xa8b5ab, true, true);
		addText(60670, "", tda, 2, 0xa8b5ab, true, true);
		addText(60671, "", tda, 2, 0xa8b5ab, true, true);
		addText(60672, "", tda, 2, 0xa8b5ab, true, true);
		addText(60673, "", tda, 2, 0xa8b5ab, true, true);
		addText(60674, "", tda, 2, 0xa8b5ab, true, true);
		addText(60675, "", tda, 2, 0xa8b5ab, true, true);
		addText(60676, "", tda, 2, 0xa8b5ab, true, true);
		addText(60677, "", tda, 2, 0xa8b5ab, true, true);
		addText(60678, "", tda, 2, 0xa8b5ab, true, true);
		addText(60679, "", tda, 2, 0xa8b5ab, true, true);
		//new teleport text
		addText(18374, "New ", tda, 2, 0xa8b5ab, true, true);
		addText(60701, "Teleport", tda, 2, 0xa8b5ab, true, true);
		addText(60702, "New", tda, 2, 0xa8b5ab, true, true);
		addText(60703, "Teleport", tda, 2, 0xa8b5ab, true, true);
		addText(60704, "New", tda, 2, 0xa8b5ab, true, true);
		addText(60705, "Teleport", tda, 2, 0xa8b5ab, true, true);
	...
	public static void lunarSpellbookInterface() {
		...
		addTooltip(11005, "City Teleport\nOpen options of different \nskilling teleports.");
	...
	private static final int DRAW_REGULAR_MODEL = 1, DRAW_NPC_MODEL = 2,
	    ...
	    "Decline");*/
			...
			private static void bankInterface() {
				...
				addBankHover(78395, 4, 78396, 1054, 1055, "Interfaces/BANK/BANK", 35, 25, 111, 1, "Toggle placeholders", 78397,
						14, 16, "Interfaces/BANK/BANK", 78398, "Toggle placeholders", "Toggle placeholders", 12, 20, 1054,
						1056);
