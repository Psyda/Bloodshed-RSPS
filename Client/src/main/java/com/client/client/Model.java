...
public class Model extends Animable {
	...
	public Model(int modelId) {
		...
		int[] priorityFix = new int[] {33103, 33111, 33102, 33114, 29249, 29254, 29250, 29255, 29252, 29253};
	...
	public void convertTexturesTo317(int modelId, short[] textureIds, int[] texa, int[] texb, int[] texc, byte[] texture_coordinates) {
		int set = 0;
		int set2 = 0;
		boolean osrs = (modelId == 33144 || modelId == 33145 || modelId == 33103 || modelId == 33111 || modelId == 33102 || modelId == 33114);
