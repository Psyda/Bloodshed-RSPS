...
public class PlayerSaving {
	...
	public static void save(Player player) {
		...
		try (FileWriter writer = new FileWriter(file)) {
			...
			for (Entry<Integer> dartItem : player.getMagmaBlowpipeLoading().getContents().entrySet()) {
				object.addProperty("magmablowpipe-charge-item", new Integer(dartItem.getElement()));
				object.addProperty("magmablowpipe-charge-amount",
						new Integer(player.getMagmaBlowpipeLoading().getContents().count(dartItem.getElement())));
			}
			...
			object.add("set-home", builder.toJsonTree(player.getHome()));
