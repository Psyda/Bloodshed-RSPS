...
import com.ruseps.world.content.Gamble;
...
import com.ruseps.world.content.MagmaBlowpipeLoading;
...
public class Player extends Character {
	...
	public Position home = new Position(2719, 5313);
	...
	private boolean searchedNpc;

	public boolean searchedNpc() {
		return searchedNpc;
	}
    @Override
	...
	public void setsearchedNpc(boolean searchedNpc) {
		this.searchedNpc =searchedNpc;
	}
	...
	public void venomVictim(Character victim, CombatType type) {
		...
		if ((type == CombatType.RANGED && weaponId == 12926)) {
			CombatFactory.venomEntity(victim, CombatVenomData.getVenomType(equipment.get(Equipment.WEAPON_SLOT)));
		} else if ((type == CombatType.RANGED && weaponId == 12927)) {
			CombatFactory.venomEntity(victim, CombatVenomData.getVenomType(equipment.get(Equipment.WEAPON_SLOT)));
...
//		}
//		if(getRights() != PlayerRights.ADMINISTRATOR && getRights() != PlayerRights.OWNER && getRights() != PlayerRights.MANAGER
//			&& getRights() != PlayerRights.DEVELOPER && !getUsername().equalsIgnoreCase("wiglets")) {
//			com.everythingrs.hiscores.Hiscores.update("rxill188qelzf6x10pmgnl8frjr7dz5181ml5ge6d94b0ozuxrjba2k584puc8ixr3pnfczyqfr", 
//					"Normal Mode",this.getUsername(), this.getRights().ordinal(), playerXP, true);
//			return true;
//		}
		return true;
	}
	...
	private final Stopwatch lastPray = new Stopwatch();
	...
	private MagmaBlowpipeLoading magmablowpipeLoading = new MagmaBlowpipeLoading(this);
	...
	public MagmaBlowpipeLoading getMagmaBlowpipeLoading() {
		return magmablowpipeLoading;
	}
	...
	public void setKC(int KC, boolean add) {
		if (add)
			this.KC += KC;
		else
			this.KC = KC;
	...
	public int getBossKC() {
		return BossKC;
	}

	public void setBossKC(int BossKC, boolean add) {
		if (add)
			this.BossKC += BossKC;
		else
			this.BossKC = BossKC;
