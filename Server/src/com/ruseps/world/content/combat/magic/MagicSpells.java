...
public enum MagicSpells {
	...
	public static boolean handleMagicSpells(Player p, int buttonId) {
		...
		case VENGEANCE:
			...
			if (p.getRights() == PlayerRights.PLAYER || p.getRights() == PlayerRights.BRONZE_MEMBER || p.getRights() == PlayerRights.SILVER_MEMBER || p.getRights() == PlayerRights.VETERAN) {
			...
			if (p.getRights() == PlayerRights.GOLD_MEMBER || p.getRights() == PlayerRights.SUPPORT) {
			...
			if (p.getRights() == PlayerRights.PLATINUM_MEMBER || p.getRights() == PlayerRights.MODERATOR) {
			...
			if (p.getRights() == PlayerRights.DIAMOND_MEMBER || p.getRights() == PlayerRights.RUBY_MEMBER) {
