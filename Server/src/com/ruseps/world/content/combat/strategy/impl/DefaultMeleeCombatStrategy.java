...
public class DefaultMeleeCombatStrategy implements CombatStrategy {
    ...
    public boolean canAttack(Character entity, Character victim) {
    	...
    	if(entity.isPlayer()) {
    		...
    		if(player.getEquipment().contains(14018) && player.getLocation() == Location.WILDERNESS) {
    			player.getPacketSender().sendMessage("You cannot use the ornate katana in the wilderness.");
    			return false;
    		}
    	}
