...
public class CombatRangedAmmo {
	...
	public enum RangedWeaponData {
		...
		SACRED_CLAY_BOW(new int[] {14121}, new AmmunitionData[] {AmmunitionData.BRONZE_ARROW, AmmunitionData.IRON_ARROW, AmmunitionData.STEEL_ARROW, AmmunitionData.MITHRIL_ARROW, AmmunitionData.ADAMANT_ARROW, AmmunitionData.RUNE_ARROW, AmmunitionData.BROAD_ARROW, AmmunitionData.DRAGON_ARROW}, RangedWeaponType.SHORTBOW),
		HEXHUNTER_BOW(new int[] {17295}, new AmmunitionData[] {AmmunitionData.BRONZE_ARROW, AmmunitionData.IRON_ARROW, AmmunitionData.STEEL_ARROW, AmmunitionData.MITHRIL_ARROW, AmmunitionData.ADAMANT_ARROW, AmmunitionData.RUNE_ARROW, AmmunitionData.BROAD_ARROW, AmmunitionData.DRAGON_ARROW}, RangedWeaponType.SHORTBOW),
		
		TWISTEDBOW(new int[] {20998}, new AmmunitionData[] {AmmunitionData.BRONZE_ARROW, AmmunitionData.IRON_ARROW, AmmunitionData.STEEL_ARROW, AmmunitionData.MITHRIL_ARROW, AmmunitionData.ADAMANT_ARROW, AmmunitionData.RUNE_ARROW, AmmunitionData.BROAD_ARROW, AmmunitionData.DRAGON_ARROW}, RangedWeaponType.SHORTBOW),

		TOXIC_BLOWPIPE(new int[] {12926}, new AmmunitionData[] {AmmunitionData.BLOWPIPE}, RangedWeaponType.BLOWPIPE),//who set this up anyways lol?daniel or arcane jejsh
		Sag(new int[] {16337, 16887}, new AmmunitionData[] {AmmunitionData.DRAGON_ARROW, AmmunitionData.SAGITARIAN_AMMO}, RangedWeaponType.LONGBOW),
		...
		HEAVY_BALLISTA(new int[] {15675, 15676}, new AmmunitionData[] {AmmunitionData.BRONZE_JAVELIN, AmmunitionData.IRON_JAVELIN, AmmunitionData.STEEL_JAVELIN, AmmunitionData.MITHRIL_JAVELIN, AmmunitionData.ADAMANT_JAVELIN, AmmunitionData.RUNE_JAVELIN}, RangedWeaponType.HEAVY_BALLISTA),
	...
	public enum AmmunitionData {
		...
		MAGMA_BLOWPIPE(new int[] {12927}, -1, 1123, 10, 20, 85, 23, 25),
		...
		SAGITARIAN_AMMO(new int[] {16477}, -1, 249, 3, 44, 55, 43, 31),
		...
		DRAGON_DART(new int[] {11230}, 1123, 226, 15, 33, 25, 45, 37),
	...
	public enum RangedWeaponType {
		...
		HAND_CANNON(5, 4),
		BLOWPIPE(5, 3),
		MAGMA_TOXIC_BLOWPIPE(5, 3)//this is your distance/speed
		;
