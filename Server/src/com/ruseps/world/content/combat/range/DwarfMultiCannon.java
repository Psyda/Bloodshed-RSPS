...
public class DwarfMultiCannon {
	...
	public static void setupCannon(final Player c) {
		if(c.getLocation() == Location.GAMBLING || c.getLocation() == Location.VARROCK || c.getLocation() == Location.EDGE || c.getLocation() == Location.DUEL_ARENA ||c.getLocation() == Location.DROPPARTY ) {
