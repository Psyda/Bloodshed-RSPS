...
public class EquipmentBonus {
	...
	public static boolean isWearingVenomProtection(Player player) {
		return player.getEquipment().getItems()[Equipment.HEAD_SLOT].getId() == 12282
				|| player.getEquipment().getItems()[Equipment.HEAD_SLOT].getId() == 12279
				|| player.getEquipment().getItems()[Equipment.HEAD_SLOT].getId() == 12278;
	}
