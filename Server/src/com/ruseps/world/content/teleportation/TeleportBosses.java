...
public class TeleportBosses extends Teleporting  {
	...
	public static enum Bosses {
		TELEPORT_1(new String[] {"King Black", "Dragon"}, new int[] {2273, 4681, 15}),
		TELEPORT_2(new String[] {"Godwars", "Dungeon"}, new int[] {2871, 5319, 2}),
		TELEPORT_3(new String[] {"Kalphite", "Queen"}, new int[] {3488, 9516, 0}),
		TELEPORT_4(new String[] {"Slash", "Bash"}, new int[] {2464, 9445, 0}),
		TELEPORT_5(new String[] {"Frost Dragons", "(wilderness)"}, new int[] {2955, 3889, 0}),
		...
		TELEPORT_10(new String[] {"Bork", "Cave"}, new int[] {3104, 5536, 0}),
		TELEPORT_11(new String[] {"Barrelchest", "Area"}, new int[] {2973, 9517, 3}),
		TELEPORT_12(new String[] {"Lizardman", "Shaman"}, new int[] {2398, 5020, 1});
		/**
