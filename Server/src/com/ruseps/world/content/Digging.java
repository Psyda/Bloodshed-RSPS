									...
									stop();
										...
										stop();
											...
											stop();
												...
												else if (inClue(player.getPosition(), 3209, 3435))
												...
												else if (inClue(player.getPosition(), 3231, 3299))
													if (player.getInventory().contains(2687)) {
												...
												else if (inClue(player.getPosition(), 3564, 3289))
													if (player.getInventory().contains(2688)) {
												...
												else if (inClue(player.getPosition(), 2833, 9564))
													if (player.getInventory().contains(2689)) {
												...
												else if (inClue(player.getPosition(), 3413, 3537))
													if (player.getInventory().contains(2690)) {
