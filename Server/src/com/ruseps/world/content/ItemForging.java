...
public class ItemForging {
	...
	private static enum ItemForgeData {
		...
		DRYGORE_RAPIER(new Item[] {new Item(6103), new Item(18349)}, new Item(20059), new int[] {1, -1, 0}),
		DRYGORE_MACE(new Item[] {new Item(6103), new Item(18353)}, new Item(20058), new int[] {1, -1, 0}),
		DRYGORE_LONGSWORD(new Item[] {new Item(6103), new Item(18351)}, new Item(20057), new int[] {1, -1, 0}),
		
		
		
		
		FULL_SLAYER_HELMET(new Item[] {new Item(13263), new Item(15490), new Item(15488)}, new Item(15492), new int[] {18, 75, 0}),
		RED_SLAYER_HELMET(new Item[] {new Item(13263), new Item(7986)}, new Item(8465), new int[] {1, -1, 0}),
		GREEN_SLAYER_HELMET(new Item[] {new Item(13263), new Item(7981)}, new Item(8467), new int[] {1, -1, 0}),
		BLACK_SLAYER_HELMET(new Item[] {new Item(13263), new Item(7980)}, new Item(8469), new int[] {1, -1, 0}),
		;
