...
public enum SlayerTasks {
	...
	BANSHEE(SlayerMaster.VANNAKA, 1612, "Banshees can be found in the Slayer Tower." , 1000, new Position(3442, 3540, 0)),
	 ...
	 * Hard tasks
	 */
	ABYSSAL_DEMON(SlayerMaster.KURADEL, 1615, "Abyssal Demons can be found in the Slayer Tower.", 12500, new Position(3418, 3566, 0)),
	BLACK_DRAGON(SlayerMaster.KURADEL, 54, "Black Dragons can be found in Taverly Dungeon.", 12500, new Position(2836, 9826, 0)),
	 ...
	 * Elite
	 */
	COMMANDER_ZILYANA(SlayerMaster.SUMONA, 6247, "Commander Zilyana can be found east in the Godwars Dungeon.", 68000, new Position(2900, 5264)),
	ZAMMY_TSUTSAROTH(SlayerMaster.SUMONA, 6203, "K’ril Tsutsaroth can be found north in the Godwars Dungeon.", 68000, new Position(2926, 5328)),
	KREE_ARRA(SlayerMaster.SUMONA, 6222, "Kree’arra can be found south in the Godwars Dungeon.", 68000, new Position(2835, 5300)),
	CERBERUS(SlayerMaster.SUMONA, 1999, "Cerberus can be found using the Boss teleport.", 50000, new Position(1240, 1246)),
	ABYSSAL_SIRE(SlayerMaster.SUMONA, 5886, "The Abyssal Sire can be found using the Boss teleport.", 40000, new Position(3373, 3893)),
	SCORPIA(SlayerMaster.SUMONA, 2001, "Scorpia can be found deep in the wilderness using the Boss teleport.", 40000, new Position(3236, 3944)),
	VENENATIS(SlayerMaster.SUMONA, 2000, "Venenatis can be found deep in the wilderness using the Boss teleport.", 50000, new Position(3269, 3722)),
	GLACOR(SlayerMaster.SUMONA, 1382, "Glacors can be found using the Boss teleport.", 25000, new Position(3053, 9577)),
	...
	LIZARMAN(SlayerMaster.SUMONA, 6766, "The lizardman can be found using the Boss teleport.", 40000, new Position(2398, 5020)),
	BORKS(SlayerMaster.SUMONA, 7134, "The Bork can be found using the Boss teleport.", 50000, new Position(3104, 5536)),
	
	KRAKEN(SlayerMaster.SUMONA, 3847, "The Kraken can be found using the Boss teleport.", 45000, new Position(3094, 3503)),
	GIANT_MOLE(SlayerMaster.SUMONA, 3340, "The Giant Mole can be found using the Boss teleport.", 45000, new Position(1761, 5181)),
