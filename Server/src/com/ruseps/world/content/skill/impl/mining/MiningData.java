...
public class MiningData {
	...
	public static enum Ores {
		...
		Coal(new int[]{2097, 5770, 29216, 29215, 29217, 11965, 11964, 11963, 11930, 11931}, 30, 3450, 453, 5, 7),
		...
		InfiniteRunite(new int[] {14860}, 85, 20000, 452, 6, -1),
		InfiniteCoal(new int[]{11932}, 30, 6900, 454, 5, -1),
