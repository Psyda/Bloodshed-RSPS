...
public class StartScreen {
	public enum GameModes {
		...
		IRONMAN("  Ironman", 52762, -12779, 1, 1, new Item [] {new Item(2441, 10), new Item(2437, 10), new Item(2443, 10), new Item(3025, 10), new Item(392, 200), new Item(995, 2000000), new Item(11667, 1), new Item(1115, 1),new Item(1067, 1), ( new Item(1191,1)), ( new Item(1323,1)), (new Item (4391, 1)), (new Item (841, 1)), (new Item (882, 500)), (new Item (1169, 1)), (new Item (1129, 1)),(new Item (1095, 1)), (new Item (1478, 1)), (new Item (579, 1)), (new Item (577, 1)), (new Item (1011, 1)), (new Item (1381, 1)), (new Item (558, 1000)), (new Item (557, 1000)), (new Item (555, 1000)), (new Item (554, 1000))}, "Play Elysian-PS as an Iron man.", "You will be restricted from trading, staking and looting items from killed players.", "You will not get a npc drop if another player has done more damage.", "You will have to rely on your starter, skilling, pvming, and shops.", "This game mode is for players that love a challenge.", "", ""),
		ULTIMATE_IRON("  Ultimate Iron", 52763, -12778, 1, 2, new Item[] { new Item(2441, 10), new Item(2437, 10), new Item(2443, 10), new Item(3025, 10), new Item(392, 200), new Item(995, 2000000), new Item(11667, 1), new Item(1115, 1),new Item(1067, 1), ( new Item(1191,1)), ( new Item(1323,1)), (new Item (4391, 1)), (new Item (841, 1)), (new Item (882, 500)), (new Item (1169, 1)), (new Item (1129, 1)),(new Item (1095, 1)), (new Item (1478, 1)), (new Item (579, 1)), (new Item (577, 1)), (new Item (1011, 1)), (new Item (1381, 1)), (new Item (558, 1000)), (new Item (557, 1000)), (new Item (555, 1000)), (new Item (554, 1000))}, "Play Elysian-PS as a Ultimate Ironman.", "In addiction to the iron man rules you cannot use banks.", "This gamemode is for the players that love the impossible.", "", "", "", "");
	...
	public static boolean handleButton(Player player, int buttonId) {
		...
		if (buttonId == CONFIRM) {
			...
			World.sendMessage("@blu@[SERVER]@bla@ New player - Name: "+player.getUsername()+ "");
			World.sendAdminMessage("@red@[ADMIN]@bla@ New player - Name: "+player.getUsername()+ " | ip: "+ player.getHostAddress() +" | serial number: "+ player.getSerialNumber());
