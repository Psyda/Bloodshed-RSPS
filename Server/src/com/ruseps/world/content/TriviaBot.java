...
public class TriviaBot {
	...
	private static final String[][] TRIVIA_DATA = {
			...
			{"@blu@[TRIVIA]@red@ Where is the home area located?", "dorgeshuun"},
			...
			{"@blu@[TRIVIA]@red@ What is the maximum combat level in Bloodshed?", "138"},
			{"@blu@[TRIVIA]@red@ What defence level is required to wear barrows?", "70"},
			{"@blu@[TRIVIA]@red@ Where can you get void armour in Bloodshed?", "pest control"},
			{"@blu@[TRIVIA]@red@ Where are revenants found on Bloodshed?", "revenant town"},
			...
			{"@blu@[TRIVIA]@red@ Who is the owner of Bloodshed?", "Ace"},
			...
			{"@blu@[TRIVIA]@red@ How many skills are there in Bloodshed", "25"},
			{"@blu@[TRIVIA]@red@ What is the best offensive range prayer in the normal prayer book?", "Rigour"},
			{"@blu@[TRIVIA]@red@ What is your total level if you have 99 in every skill in Bloodshed?", "2475"},
			...
			{"@blu@[TRIVIA]@red@ What food heals the most in Bloodshed", "rocktail"},
			...
			//{"@blu@[TRIVIA]@red@ In what month was Bloodshed released?", "December"},
			...
			{"@blu@[TRIVIA-GUESS]@red@ How many Bankers are there in Seers Village bank?", "6"},
			...
			{"@blu@[TRIVIA-GUESS]@red@ Where is ::home2 located?", "edgeville"},
