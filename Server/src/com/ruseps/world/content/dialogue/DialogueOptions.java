...
import com.ruseps.model.input.impl.EnterAmountOfBonesOnAltar;
...
import com.ruseps.world.content.minigames.impl.InfernoBoss;
...
public class DialogueOptions {
	...
	public static void handle(Player player, int id) {
		...
		if (id == FIRST_OPTION_OF_FIVE) {
			...
			case 241: //city teleport 1 Falador
				TeleportHandler.teleportPlayer(player, new Position(2965, 3383),
			...
			case 277:
				...
				if (player.getInventory().getAmount(995) >= 100000000) {
					player.getInventory().add(12632, 1);
					player.getInventory().delete(995, 100000000);
					player.getPA().sendMessage("@blu@You have purchased 1x (100m Note)");
				} else {
			...
			switch (player.getDialogueActionId()) {
			case 241: //city teleport 2 Varrock
				TeleportHandler.teleportPlayer(player, new Position(3213, 3424),
						player.getSpellbook().getTeleportType());
				break;
			case 133:
			...
			case 239:
				Scoreboards.open(player, Scoreboards.TOP_MONEY_POUCH);
				break;
			case 277:
				player.getPA().sendInterfaceRemoval();
				if (player.getInventory().getAmount(995) >= 300000000) {
					player.getInventory().add(12632, 3);
					player.getInventory().delete(995, 300000000);
					player.getPA().sendMessage("@blu@You have purchased 3x (100m Note)");
				} else {
					player.getPA().sendMessage("@red@You do not have enough coins in your inventory!");
				}
			...
			case 13:
				...
				World.sendMessage("@blu@<img=10> " + player.getUsername()
			...
			switch (player.getDialogueActionId()) {
			case 241: //city teleport 3 Camelot
				TeleportHandler.teleportPlayer(player, new Position(2757, 3477),
						player.getSpellbook().getTeleportType());
				break;
			case 133:
			...
			case 239:
				Scoreboards.open(player, Scoreboards.TOP_BOSS_KILLS);
				break;
			case 277:
				player.getPA().sendInterfaceRemoval();
				if (player.getInventory().getAmount(995) >= 500000000) {
					player.getInventory().add(12632, 5);
					player.getInventory().delete(995, 500000000);
					player.getPA().sendMessage("@blu@You have purchased 5x (100m Note)");
				} else {
					player.getPA().sendMessage("@red@You do not have enough coins in your inventory!");
				}
			...
			case 10:
				...
				break;
			case 11:
				Scoreboards.open(player, Scoreboards.TOP_TOTAL_LEVEL);
				break;
			case 12:
			...
			switch (player.getDialogueActionId()) {
			case 241: //city teleport 4 Edgeville
				TeleportHandler.teleportPlayer(player, new Position(3094, 3503),
						player.getSpellbook().getTeleportType());
				break;
			case 133:
			...
			case 239:
				Scoreboards.open(player, Scoreboards.TOP_TOTAL_KILLS);
				break;
			case 277:
				player.getPA().sendInterfaceRemoval();
			...
			case 13:
				...
				World.sendMessage(
						"@blu@<img=10> " + player.getUsername() + " has obtained a max cape. Huge congratulations!");
			...
			case 40:
				...
				break;
			case 41:
				TeleportHandler.teleportPlayer(player, new Position(3389, 3722),
						player.getSpellbook().getTeleportType());
				break;
			case 48:
			...
			switch (player.getDialogueActionId()) {
			case 241: //city teleport 5 Ardogune
				TeleportHandler.teleportPlayer(player, new Position(2662, 3307),
						player.getSpellbook().getTeleportType());
				break;
			case 277:
				player.getPA().sendInterfaceRemoval();
				if (player.getInventory().getAmount(995) >= 1000000000) {
					...
					player.getInventory().delete(995, 1000000000);
					player.getPA().sendMessage("@blu@You have purchased a (1B Note)");
				} else {
					player.getPA().sendMessage("@red@You do not have enough coins in your inventory!");
				}
			...
			case 239:
				...
				break;
			case 11:
				player.setDialogueActionId(239);
			...
			case 5:
				...
				if (player.getRights() == PlayerRights.PLAYER) {
					player.getPacketSender().sendMessage("You need to be a member to teleport to this zone.")
							.sendMessage(
									"To become a member, visit www.Elysian-PS.com and visit the store for more information.");
					return;
				}
			...
			case 31:
				...
				break;
			case 45:
				player.getPacketSender().sendString(1, "http://Elysian-PS.com");
				break;
			}
			...
			switch (player.getDialogueActionId()) {
			case 240:
				player.getPacketSender().sendMessage("You have set your home teleport to Dorgeshuun!");
				player.setHome(new Position(2719, 5313));
				player.getPacketSender().sendInterfaceRemoval();
				break;
			case 1005:
				if (player.getInventory().contains(6570)) {
					player.getPacketSender().sendInterfaceRemoval();
					//player.getInventory().delete(6570, 1);
					player.moveTo(new Position(2270, 5350, player.getIndex() * 4));
					...
					player.getPacketSender().sendMessage("You must have a Fire cape to fight TzKal-Zuk");
					player.getPacketSender().sendInterfaceRemoval();
				}
				break;
			case 391:
				...
				case 478:
					player.getPA().sendInterfaceRemoval();
					ZulrahInstance.startInstance(player, false);
					break;
			case 111:
				player.getPacketSender().sendInterfaceRemoval();
			...
			switch (player.getDialogueActionId()) {
			case 240:
				player.getPacketSender().sendMessage("You have set your home teleport to Edgeville!");
				player.setHome(new Position(3096, 3503));
				player.getPacketSender().sendInterfaceRemoval();
				break;
			case 478:
			case 1005:
			...
			case 1000:
				...
				player.setDialogueActionId(1005);
				break;
			case 15:
				DialogueManager.start(player, 25);
				player.setDialogueActionId(15);
