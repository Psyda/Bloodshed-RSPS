	...
	public static Dialogue get(Player p, int stage) {
		...
		case 1:
			dialogue = new Dialogue() {
				...
				@Override
				public String[] dialogue() {
					return new String[]{"You can earn money doing many different things in", "Elysian-PS. For example, see those Thieving stalls infront of ", "you? You can steal items from them and sell them to the", "merchant whose standing over there."};
				};
		...
		case 6:
			dialogue = new Dialogue() {
				...
				@Override
				public String[] dialogue() {
					return new String[]{"Enough of the boring stuff, let's show you some creatures!", "There are a bunch of bosses to fight in Elysian-PS.", "Every boss drops unique and good gear when killed.", "One example is the mighty Pohenix!"};
				};
		...
		case 8:
			dialogue = new Dialogue() {
				...
				@Override
				public String[] dialogue() {
					return new String[]{"Elysian-PS also has a lot of enjoyable minigames.", "This is the Graveyard Arena, an area that's been run over", "by Zombies. Your job is to simply to kill them all.", "Sounds like fun, don't you think?"};
				};
		...
		case 11:
			dialogue = new Dialogue() {
				...
				@Override
				public String[] dialogue() {
					return new String[]{"Elysian-PS is a competitive game. Next to you is a scoreboard", "which you can use to track other players and their progress."};
				};
		...
		case 13:
			dialogue = new Dialogue() {
				...
				@Override
				public String[] dialogue() {
					return new String[]{"If you have any more questions, simply use the ::help", "command and a staff member should get back to you.", "You can also join the clanchat channel 'help' and ask", "other players for help there too. Have fun playing Elysian-PS!"};
				};
		...
		case 14:
			dialogue = new Dialogue() {
				...
				public void specialAction() {
					...
					World.sendMessage("<img=10> <col=6600CC>[NEW PLAYER]: "+p.getUsername()+" has logged into Elysian-PS for the first time!");
