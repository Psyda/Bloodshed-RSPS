...
public class TreasureChest {
	...
	public static void handleDrops(Player player, int npc, Position pos) {
		int key = 0;
		if(npc == 133) {
		key = 14678;
		}
		...
		//if(Misc.getRandom(2) == 1) {
			...
			GroundItemManager.spawnGroundItem(player, new GroundItem(new Item(key), pos, player.getUsername(), false, 150, true, 200));
		//} else {
	...
	public static void handleLoot(Player p) {
		...
		for (int i = 0; i < 1; i++) {
			...
			p.getInventory().add(item2.getId(), amount2);
			

			p.getInventory().add(995, 1000000 + Misc.getRandom(500000));
		}
	...
	public static final Item[] uncommonRewards = {
		...
		new Item(6199, 1), //Zamorakian spear
		new Item(15501, 1), //Zamorakian spear
		new Item(2577, 1),
		new Item(2581, 1),
		new Item(6585, 1),
		new Item(19335, 1),
	...
	//	new Item(20012, 1),
		...
		new Item(10942, 1),
		//new Item(1050, 1),
		new Item(995, 300000000),
		new Item(995, 150000000),
		new Item(995, 75000000),
		new Item(995, 125000000),
		new Item(995, 150000000),
		new Item(995, 75000000),
		new Item(995, 125000000),
