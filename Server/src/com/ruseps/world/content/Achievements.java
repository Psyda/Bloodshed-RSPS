...
public class Achievements {
	...
	public static void finishAchievement(Player player, AchievementData achievement) {
		...
		if (player.getPointsHandler().getAchievementPoints() == 5 || player.getPointsHandler().getAchievementPoints() == 10 || player.getPointsHandler().getAchievementPoints() == 15
				|| player.getPointsHandler().getAchievementPoints() == 20 || player.getPointsHandler().getAchievementPoints() == 25 || player.getPointsHandler().getAchievementPoints() == 30
				|| player.getPointsHandler().getAchievementPoints() == 35 || player.getPointsHandler().getAchievementPoints() == 40 || player.getPointsHandler().getAchievementPoints() == 45
				|| player.getPointsHandler().getAchievementPoints() == 50 || player.getPointsHandler().getAchievementPoints() == 55 || player.getPointsHandler().getAchievementPoints() == 60
				|| player.getPointsHandler().getAchievementPoints() == 65 || player.getPointsHandler().getAchievementPoints() == 70 || player.getPointsHandler().getAchievementPoints() == 75
				|| player.getPointsHandler().getAchievementPoints() == 80 || player.getPointsHandler().getAchievementPoints() == 85 || player.getPointsHandler().getAchievementPoints() == 90
				|| player.getPointsHandler().getAchievementPoints() == 95) {
			player.getInventory().add(989, 1);
		}
		
		if (player.getPointsHandler().getAchievementPoints() == 25) {
			World.sendMessage("<img=10><col=6600CC> Congratulate "+ player.getUsername() + " for just completing their 25th achievement!");
		}
		
		if (player.getPointsHandler().getAchievementPoints() == 50) {
			World.sendMessage("<img=10><col=6600CC> Congratulate "+ player.getUsername() + " for just completing their 50th achievement!");
		}
		
		if (player.getPointsHandler().getAchievementPoints() == 75) {
			World.sendMessage("<img=10><col=6600CC> Congratulate "+ player.getUsername() + " for just completing their 75th achievement!");
		}
