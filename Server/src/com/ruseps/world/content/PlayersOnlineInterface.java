...
public class PlayersOnlineInterface {
	...
	private static void clearInterface(Player player) {
		...
		player.getPacketSender().sendString(i++, "Boss Points:");
		player.getPacketSender().sendString(i++, "Achievement Points:");
	}
	...
	public static void showInterface(Player player) {
		...
		player.getPacketSender().sendString(57003, "Players:  @gre@"+(World.getPlayers().size())+"").sendInterface(57000);
	}
	...
	private static void updateInterface(Player player, int index) {
		...
		sendString(57022, "Wild Deaths: @whi@"+player2.getPlayerKillingAttributes().getPlayerDeaths()).sendString(57023, "Boss Points: @whi@"+player2.getBossPoints()).
		sendString(57024, "Achievement Points: @whi@"+player2.getPointsHandler().getAchievementPoints());
	}
