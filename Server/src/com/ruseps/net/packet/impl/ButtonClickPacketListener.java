...
import com.ruseps.model.input.impl.PosInputItem;
...
public class ButtonClickPacketListener implements PacketListener {
	...
	public void handleMessage(Player player, Packet packet) {
		...
		case 11014:
			...
			break;
		case -26333:
			player.getPacketSender().sendString(1, "www.Elysian-PS.com/community/");
			player.getPacketSender().sendMessage("Attempting to open the site.");
			break;
		case -26332:
			player.getPacketSender().sendString(1, "www.Elysian-PS.com/");
			player.getPacketSender().sendMessage("Attempting to open the site.");
			break;
		case -26331:
			player.getPacketSender().sendString(1, "www.Elysian-PS.com/store/");
			player.getPacketSender().sendMessage("Attempting to open the site.");
			break;
		case -26330:
			player.getPacketSender().sendString(1, "www.Elysian-PS.com/vote/");
			player.getPacketSender().sendMessage("Attempting to open the site.");
			break;
		case -26329:
			player.getPacketSender().sendString(1, "www.Elysian-PS.com/hiscores/");
			player.getPacketSender().sendMessage("Attempting to open the site.");
			break;
		case -26328:
			player.getPacketSender().sendString(1, "www.Elysian-PS.com/");
		...
		case 8658:
			...
			break;
		case 30894:
			player.getPacketSender().sendMessage("<img=10> This mode is currently disabled, please choose a different one.");
			break;
		case 11001:
		...
		case 8659:
			...
			break;
		case 8664:
			TeleportHandler.teleportPlayer(player, new Position(2711, 5330), player.getSpellbook().getTeleportType());
			break;
		case 8666:
		...
		case 8671:
			TeleportHandler.teleportPlayer(player, new Position(2721, 3462), player.getSpellbook().getTeleportType());
			break;
		case 8670:
...
//			player.setDialogueActionId(-1);
			...
			player.setDialogueActionId(241);
			break;
		case 8654:
		case 8657:
		case 8655:
		...
		case 26718:
			if(player.soundsActive() == true) {
				...
				player.getPacketSender().sendString(26717, "@or2@Sounds:  @gre@"+(player.soundsActive() ? "On" : "Off")+"");		player.getPacketSender().sendString(26717, "@or2@Sounds:  @gre@"+(player.soundsActive() ? "On" : "Off")+"");		
			}
			break;
		case 2799:
		case 2798:
		...
		case 26713:
			if(player.getAmountDonated() > 100) {
				...
				player.getPacketSender().sendMessage("You need to be at least a gold donator to change your yell title this way.");
			}
			PlayerPanel.refreshPanel(player);
			break;
		...
		case 26716:
			player.setExperienceLocked(!player.experienceLocked());
			String type1 = player.experienceLocked() ? "locked" : "unlocked";
			player.getPacketSender().sendMessage("Your experience is now "+type1+".");
			PlayerPanel.refreshPanel(player);
			break;
		case 27651:
		case 21341:
