...
import com.ruseps.world.content.treasuretrails.CoordinateScrolls;
import com.ruseps.world.content.treasuretrails.DiggingScrolls;
import com.ruseps.world.content.treasuretrails.MapScrolls;
import com.ruseps.world.content.treasuretrails.Puzzle;
import com.ruseps.world.content.treasuretrails.SearchScrolls;
...
public class ItemActionPacketListener implements PacketListener {
	...
	private static void firstAction(final Player player,  Packet packet) {
		...
		case 5023:
			...
			player.getPacketSender().sendString(8135, ""+player.getMoneyInPouch());
			player.getClickDelay().reset();
			player.getPA().sendMessage("@blu@1B Coins has been added to your money pouch");
			} else {
				player.getPA().sendMessage("Wait a few seconds between claiming");
			}
			break;
		...
		case 8012: //Watchtower Tele
			...
			TaskManager.submit(new Task(2, player, false) {
			 ...
			 break;
		case 8013: //Home Tele
			 TeleportHandler.teleportPlayer(player, new Position(2717, 5313), TeleportType.NORMAL);
			 break;
		...
		case 15501:
			int superiorRewards[][] = {
					...
					{11235, 17273, 14484, 11696, 11698, 11700, 20000, 20001, 20002, 13899, 11613, 19780, 20072, 15486, 19336, 19337, 19338, 19339, 19340, 14009, 14010, 14008} //Legendary, 3
			};
	...
	public void thirdClickAction(Player player, Packet packet) {
		...
		case 12926:
			...
			break;
		case 12927:
			player.getMagmaBlowpipeLoading().handleCheckBlowpipe();
			break;
		case 19670:
			if(player.busy()) {
				player.getPacketSender().sendMessage("You can not do this right now.");
		...
		case 6500:
			...
			break;
		case 14009:
			player.getInventory().delete(14009, 1);
			player.getInventory().add(19476, 1);
			break;
		case 19476:
			...
			break;
		case 19477:
			player.getInventory().delete(19477,1);
			player.getInventory().add(14008,1);
			break;
		case 14008:
			player.getInventory().delete(14008, 1);
			player.getInventory().add(19477, 1);
			break;
		case 14010:
			player.getInventory().delete(14010, 1);
			player.getInventory().add(19478, 1);
			break;
			case 19478:
			player.getInventory().delete(19478, 1);
