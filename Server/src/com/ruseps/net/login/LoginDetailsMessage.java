...
public final class LoginDetailsMessage {
     ...
     */
    public LoginDetailsMessage(String username, String password, String host, String serial_number, int clientVersion, int uid, String hash, int pinCode, String authCode) {
