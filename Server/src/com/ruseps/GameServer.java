...
public class GameServer {
	...
	private static final Logger logger = Logger.getLogger("Elysian-PS");
	...
	public static void main(String[] params) {
		...
		try {
			...
			logger.info("Elysian-PS is now online on port "+GameSettings.GAME_PORT+"!");
			
	


		} catch (Exception ex) {
			logger.log(Level.SEVERE, "Could not start Elysian-PS! Program terminated.", ex);
			System.exit(1);
		}
	}
