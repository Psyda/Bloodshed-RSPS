...
public class Store {
	...
	private static final String SECRET = "cvvnb431kwjw2305"; //YOUR SECRET KEY!
			...
			new Thread(new Runnable() {
				...
				public void run() {
					...
					try {
						...
						URL url = new URL("/store/callback.php?secret="+SECRET+"&username="+URLEncoder.encode(player.getUsername().toLowerCase().replaceAll(" ", "_")));
